...
export const metadata: Metadata = {
  title: "AI 트렌드 분석 방법론",
  description: "오늘의AI가 공개 신호를 수집하고 Trend Score와 Trust Score를 계산하며 한국어 분석을 만드는 방법을 설명합니다.",
  alternates: { canonical: "/methodology" },
  openGraph: { title: "AI 트렌드 분석 방법론 | 오늘의AI", description: "수집 채널, 점수 원칙, AI 분석과 검수 기준을 투명하게 공개합니다.", url: "/methodology", type: "article" },
};

const steps = [
  // 채널 이름은 적지 않는다. 이 페이지는 정적 렌더링이라 빌드 시점 값이 굳어, 채널이 늘거나
  // 막혀도 다음 배포까지 틀린 목록을 보여준다. 실제 목록은 홈 화면이 라이브 데이터로 표시한다.
  ["1. 공개 신호 수집", "연결된 공개 채널의 저장소 활동과 게시물 반응을 수집합니다. 연결되지 않은 채널의 신호는 있는 것처럼 표시하지 않으며, 실제 수집 채널은 홈 화면에 표시됩니다."],
