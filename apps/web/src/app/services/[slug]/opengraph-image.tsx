...
export const alt = "오늘의AI 서비스 트렌드 분석";
  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "68px 76px", color: "#171a21", background: "#f6f7f9", fontFamily: "Arial, sans-serif" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}><div style={{ width: 54, height: 54, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: 15, color: "white", fontSize: 21, fontWeight: 800, background: "linear-gradient(135deg, #6d5dfb, #17bfd3)" }}>AI</div><span style={{ fontSize: 28, fontWeight: 700 }}>오늘의AI</span></div>
